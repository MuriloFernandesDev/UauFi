...
export const getData = createAsyncThunk('admCliente/getData', async parametros => {
...
export const addData = createAsyncThunk('admCliente/addData', 
...
export const updateData = createAsyncThunk('admCliente/updateData', 
  async (dados, { dispatch, getState }) => {
...
export const deleteCliente = createAsyncThunk('admCliente/deleteCliente', 
