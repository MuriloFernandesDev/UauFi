...
const ClienteEditCard = ({ data, setSalvarDados }) => {
  ...
  const [vArtigoGenero, setArtigoGenero] = useState((data && (data?.artigo_genero !== null)) ? { label: data?.artigo_genero, value: data?.artigo_genero } : null)
  ...
  const getEstados = () => {
    return api.get('/estado').then(res => {
      setListaEstados(res.data.map(ret => ({ label: ret.nome, value: ret.id })))
  ...
  //Selecionar o item no componente
  if ((!vEstado) && (vListaEstados) && (vDados?.estado_id !== null) && (vDados !== null)) {
  ...
  //Selecionar o item no componente
  if ((!vCidade) && (vListaCidades) && (vEstado) && (vDados?.cidade_id !== null) && (vDados !== null)) {
                  ...
                  <Row>
                    ...
                    <Col md='2' className='mb-2 text-center'>
                      ...
                      <div className='form-switch form-check-primary'>
                        <Input type='switch' id='agregador' checked={vDados?.agregador ?? false} 
                        onChange={ e => {
                            handleChange({ target: { name: 'agregador', value: e.target.checked } })
                          }
                        } />
                      </div>
                    </Col>
                  ...
                  <Form onSubmit={ e => e.preventDefault() }>
                    <Row>
                      ...
                      <Col md='6' className='mb-2'>
                        ...
                        <Input id='vMinutosDesconexao' name='minutos_desconexao' value={vDadosCP?.minutos_desconexao ?? 0} onChange={ handleChangeCP} />
                      </Col>
                      <Col md='6' className='mb-2'>
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vNomeCP' checked={vDadosCP?.nome ?? false} 
                          onChange={ e => {
                              handleChangeCP({ target: { name: 'nome', value: e.target.checked } }) 
                            } 
                          } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vEmailCP' checked={vDadosCP?.email ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'email', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vCpfCP' checked={vDadosCP?.cpf ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'cpf', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vNascimentoCP' checked={vDadosCP?.nascimento ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'nascimento', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vCelularCP' checked={vDadosCP?.celular ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'celular', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vPaisCP' checked={vDadosCP?.pais ?? false}
                          onChange={ e => { handleChangeCP({ target: { name: 'pais', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vCidadeCP' checked={vDadosCP?.cidade ?? false}
                          onChange={ e => { handleChangeCP({ target: { name: 'cidade', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vSmsCP' checked={vDadosCP?.usa_sms ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'usa_sms', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vGeneroCP' checked={vDadosCP?.genero ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'genero', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vBrasileiroCP' checked={vDadosCP?.brasileiro ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'brasileiro', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vLoginSocialCP' checked={vDadosCP?.login_social ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'login_social', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vHotelCP' checked={vDadosCP?.hotel ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'hotel', value: e.target.checked } }) } } />
                      ...
                      <Col md='4' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vEmpresaRepresentaCP' checked={vDadosCP?.empresa_representa ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'empresa_representa', value: e.target.checked } }) } } />
                      ...
                      <Col md='8' className='mb-2'>
                        <div className='form-check form-switch'>
                          <Input type='switch' id='vIndicacaoCP' checked={vDadosCP?.indicacao ?? false} 
                          onChange={ e => { handleChangeCP({ target: { name: 'indicacao', value: e.target.checked } }) } } />
