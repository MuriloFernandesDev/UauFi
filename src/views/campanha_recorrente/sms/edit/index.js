...
// ** Editar BloqueioQuarto de conexão
import EditCard from "./EditCard"
import { getBloqueioQuarto } from "../store"
...
const BloqueioQuartoEdit = () => {
  ...
  const vParFiltro = useSelector((state) => state.bloqueio_quarto.params)
  ...
  const handleOK = () => {
    setSalvando(false)
    dispatch(getBloqueioQuarto(vParFiltro))
    navigate("/bloqueio_quarto")
  }
  ...
  useEffect(() => {
    api.get(`/bloqueio_quarto/${id}`).then((response) => {
...
export default BloqueioQuartoEdit
